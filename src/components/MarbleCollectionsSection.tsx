...
const MarbleCollectionsSection = () => {
  ...
  const categories = [
    ...
    { id: 'white', label: 'White Marble', color: 'from-gray-100 to-gray-300' },
    { id: 'green', label: 'Green Marble', color: 'from-green-600 to-green-800' },
    { id: 'golden', label: 'Golden Marble', color: 'from-yellow-400 to-yellow-600' },
    { id: 'colored', label: 'Colored Marble', color: 'from-pink-400 to-purple-600' },
  ];

  // Use the comprehensive marble products data
  const collections = marbleProducts.map((product, index) => ({
    id: index + 1,
    name: product.name,
    category: product.subcategory || (product.name.toLowerCase().includes('white') ? 'white' : 
              product.name.toLowerCase().includes('green') ? 'green' :
              product.name.toLowerCase().includes('golden') || product.name.toLowerCase().includes('yellow') ? 'golden' : 'colored'),
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Exquisite Marble Varieties
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover our curated collection of premium marble stones, each piece telling a story of natural beauty and timeless elegance
          </p>
        </motion.div>
        ...
        >
          ...
          >
            View Complete Marble Collection
...
export default MarbleCollectionsSection;
